...
namespace VirtoCommerce.Loyalty.Data.Migrations
{
    ...
    [Migration("20220414095759_AddPointsOperationForeignKey")]
    partial class AddPointsOperationForeignKey
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VirtoCommerce.Loyalty.Data.Models.LoyaltedOrderEntity", b =>
                {
                    b.HasBaseType("VirtoCommerce.OrdersModule.Data.Model.CustomerOrderEntity");

                    b.Property<bool>("LoyaltyCalculated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.HasDiscriminator().HasValue("LoyaltedOrderEntity");
                });

            modelBuilder.Entity("VirtoCommerce.Loyalty.Data.Models.PointsOperationEntity", b =>
                {
                    b.HasOne("VirtoCommerce.Loyalty.Data.Models.UserBalanceEntity", "UserBalance")
                        .WithMany("Operations")
